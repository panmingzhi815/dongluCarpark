...
public class DeviceErrorView extends Composite implements View{
	...
	public DeviceErrorView(Composite parent, int style) {
		super(parent, style);
	...
	@Override
	public DeviceErrorPresenter getPresenter() {
		return (DeviceErrorPresenter) presenter;
	}
