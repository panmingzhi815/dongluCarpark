...
public class CashFeeCountViewer extends AbstractView {
	private Table table;
	private Combo combo_userName;

	public CashFeeCountViewer(Composite parent) {
		super(parent);
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				table.removeAll();
				try {
					getPresenter().feeCount(getTime(dateChooserCombo_start,dateTime_start),getTime(dateChooserCombo_end,dateTime_end),combo.getSelectionIndex(),combo_userName.getText());
	...
	@Override
	public CashFeeCountPresenter getPresenter() {
		return (CashFeeCountPresenter) super.getPresenter();
	}
