...
public class ReturnAccountWizardPage extends WizardPage {
	...
	protected DataBindingContext initDataBindings() {
		...
		//
		IObservableList listSystemUserModelObserveList = BeanProperties.list("listSystemUser").observe(model);
		comboViewer.setInput(listSystemUserModelObserveList);
		//
		IObservableValue observeSingleSelectionComboViewer = ViewerProperties.singleSelection().observe(comboViewer);
		IObservableValue operaUserModelObserveValue = BeanProperties.value("operaUser").observe(model);
		bindingContext.bindValue(observeSingleSelectionComboViewer, operaUserModelObserveValue, null, null);
		//
