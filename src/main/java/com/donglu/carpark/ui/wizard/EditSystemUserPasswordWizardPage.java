...
public class EditSystemUserPasswordWizardPage extends WizardPage {
	 ...
	 * @param model 
	 */
	public EditSystemUserPasswordWizardPage(SystemUserModel model) {
		super("wizardPage");
		setTitle("修改用户密码");
		setDescription("修改用户密码");
		this.model=model;
	}
	...
	protected DataBindingContext initDataBindings() {
		...
		IObservableValue oldPwdModelObserveValue = BeanProperties.value("oldPwd").observe(model);
		bindingContext.bindValue(observeTextText_3ObserveWidget, oldPwdModelObserveValue, null, null);
		//
