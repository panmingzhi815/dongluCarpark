...
public enum SystemSettingTypeEnum {
	...
	同一账号只能在一个地方登录("true"),
	启用黄名单("false"),黄名单停留时间("0"),黄名单指定时间("0"),黄名单指定时间停留次数("0"),
	
	DateBase_version("1.0.0.19"),软件版本("1.0.0.19"),发布时间("2017-06-13 14:00:00"), 更新文件夹("jar,native"), 自动下载车牌("false"), 允许设备限时("false"), 访客车名称("访客车"), 
	;
